...
java -jar %GRCPATH%/grc.jar -XML collated_appnotes_small_background.xml -O "../../firmware/src/internal_resource_main_small_background.S"
java -jar %GRCPATH%/grc.jar -XML collated_appnotes_external.xml -O "../../firmware/src/external_resource_main.hex"
