...
#include "internal_resource_main_small_background.h"
...
void APP_CreateStyleSchemesAndBackground(void)
{
    ...
    {
        backgroundInfo.pImage = (GFX_RESOURCE_HDR*)APP_INTERNAL_FLASH_BACKGROUND_IMAGE;
...
*/
// *****************************************************************************
extern NVM_READ_FUNC NVMReadFunction;
