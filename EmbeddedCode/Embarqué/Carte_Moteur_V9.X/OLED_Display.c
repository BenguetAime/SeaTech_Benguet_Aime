...
void OLED_DemoStateMachine(void)
{
    switch(demoState)
    {
        case 0://Demo name
            ...
            OLEDText( 2, 20, OLED_Text_1, SIZE_TWO, WHITE );
            OLEDText( 18, 37, OLED_Text_2, SIZE_TWO, WHITE );
        ...
        case 1://WaitTime and print Text size 1
            ...
            {
                OLEDText( 28, 5, OLED_Text_3, SIZE_ONE, WHITE );
        ...
        case 5://WaitTime and print Rectangle 1
            if(waitTimeMs+1000<g_longTimeStamp)
            {
                OLEDText( 28, 5, OLED_Text_6, SIZE_ONE, WHITE );
        ...
        case 9://WaitTime and print Circle 1
            if(waitTimeMs+1000<g_longTimeStamp)
            {
                OLEDText( 28, 5, OLED_Text_7, SIZE_ONE, WHITE );
        ...
        case 13://WaitTime and print Bar 1
            if(waitTimeMs+1000<g_longTimeStamp)
            {
                OLEDText( 28, 5, OLED_Text_8, SIZE_ONE, WHITE );
        ...
        case 17://WaitTime and print Text size 1
            if(waitTimeMs+1000<g_longTimeStamp)
            {
                OLEDText( 28, 5, OLED_Text_9, SIZE_ONE, WHITE );
                OLEDText( 28, 15, OLED_Text_10, SIZE_ONE, WHITE );      //Size 1
                OLEDUpdateDisplay ( DDGRAM_NO_CLEAR );
                waitTimeMs=g_longTimeStamp;
                demoState++;
            }
        ...
        case 18://WaitTime and print Text size 2
            if(waitTimeMs+1000<g_longTimeStamp)
            {
                OLEDText( 32, 25, OLED_Text_11, SIZE_TWO, WHITE );
                OLEDUpdateDisplay ( DDGRAM_NO_CLEAR );
                waitTimeMs=g_longTimeStamp;
                demoState++;
            }
        ...
        case 19://WaitTime and print Text size 3
            if(waitTimeMs+1000<g_longTimeStamp)
            {
                OLEDText ( 38, 40, OLED_Text_12, SIZE_THREE, WHITE );
                OLEDUpdateDisplay ( DDGRAM_CLEAR );
                waitTimeMs=g_longTimeStamp;
                demoState++;
            }
        ...
        case 20://WaitTime and clear screen and print scrolling text
            if(waitTimeMs+1000<g_longTimeStamp)
            {
                ...
                OLEDText( 38, 40, OLED_Text_13, SIZE_ONE, WHITE );
        ...
        case 21://WaitTime and and print scrolling text
            ...
            {
                OLEDText ( 38, 40, OLED_Text_14, SIZE_ONE, WHITE );
        ...
        case 22://WaitTime and and print scrolling text
            if(waitTimeMs+2000<g_longTimeStamp)
            {
                OLEDText( 38, 20, OLED_Text_15, SIZE_ONE, WHITE );
        ...
        case 23://WaitTime and and print scrolling text
            if(waitTimeMs+2000<g_longTimeStamp)
            {
                OLEDText( 38, 20, OLED_Text_16, SIZE_ONE, WHITE );
