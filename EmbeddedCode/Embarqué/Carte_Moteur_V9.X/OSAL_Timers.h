 ...
 */
   ...
   * Set a Timer
   */
  extern unsigned char OSAL_start_timerEx( unsigned char task_id, unsigned short event_id, unsigned short timeout_value );
  
  /*
   * Set a timer that reloads itself.
   */
  extern unsigned char OSAL_start_reload_timer( unsigned char taskID, unsigned short event_id, unsigned short timeout_value );

  /*
   * Stop a Timer
   */
  extern unsigned char OSAL_stop_timerEx( unsigned char task_id, unsigned short event_id );

  /*
   * Get the tick count of a Timer.
   */
  extern unsigned short OSAL_get_timeoutEx( unsigned char task_id, unsigned short event_id );
   ...
   * Count active timers
   */
  extern unsigned char OSAL_timer_num_active( void );
  ...
  */
  extern unsigned long OSAL_GetSystemClock( void );

  /*
   * Get the next OSAL timer expiration.
   * This function should only be called in OSAL_PwrMgr.c
   */
  extern unsigned short OSAL_next_timeout( void );
