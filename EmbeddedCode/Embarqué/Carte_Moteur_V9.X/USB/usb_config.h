...
#define USB_TFER_ISOCHRONOUS 1
#define USB_TFER_BULK 2
#define USB_TFER_INTERRUPT 3
#define USB_MODE USB_TFER_BULK
/** DEFINITIONS ****************************************************/
#define USB_EP0_BUFF_SIZE		64//8	// Valid Options: 8, 16, 32, or 64 bytes.
